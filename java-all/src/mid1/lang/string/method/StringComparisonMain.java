...
public class StringComparisonMain {
    public static void main(String[] args) {
        ...
        System.out.println("'b' compareTo 'a': " + "b".compareTo("a"));                    // 'b' compareTo 'a': 1
        ...
        System.out.println("str1 starts with 'Hello': " + str1.startsWith("Hello"));       // str1 starts with 'Hello': true
        System.out.println("str1 ends with 'Java!': " + str1.endsWith("Java!"));           // str1 ends with 'Java!': true
