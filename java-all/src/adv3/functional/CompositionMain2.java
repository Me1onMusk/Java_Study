...
public class CompositionMain2 {
    public static void main(String[] args) {
        ...
        // 또 다른 조합으로 사용 가능
        Function<String, Integer> stringIntegerFunc = parseInt.andThen(square);
        Integer result3 = stringIntegerFunc.apply("5");
        System.out.println("result3 = " + result3);  // result3 = 25
